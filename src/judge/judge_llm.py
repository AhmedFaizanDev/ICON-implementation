...
class JudgeLLM:
    ...
    def __init__(self, llm_config: LLMConfig):
        ...
        """
        # Create dedicated LLM config using the provided model, temperature=0.0 for deterministic scoring
    ...
    def _extract_value(self, text: str, pattern: str, default: int) -> int:
        ...
        try:
            ...
            if '1.b' in pattern or r'1\.b' in pattern:
            ...
            elif '2.b' in pattern or r'2\.b' in pattern:
                fallback_patterns = [
                    r'2\.b[:\s]*(\d+)',
                    r'2b[:\s]*(\d+)',
                    r'question\s*2[^\d]*(\d+)',
            ...
            elif '3.b' in pattern or r'3\.b' in pattern:
                fallback_patterns = [
                    r'3\.b[:\s]*(\d+)',
                    r'3b[:\s]*(\d+)',
                    r'question\s*3[^\d]*(\d+)',
